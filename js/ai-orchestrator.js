...
export const AIOrchestrator = {
     ...
     */
    init: async (userUid) => {
        logInfo("ai_orchestrator_awake", { uid: userUid });
    ...
    dispatch: async (eventType, payload) => {
        ...
        logInfo("ai_orchestrator_event", { type: eventType, matchId: payload?.matchId || "" });
                ...
                case 'DIARY_SAVED':
                    if (payload?.diaryEntry) {
                        try {
                            ...
                            // 5. Notify
                            await sendCoreNotification(targetUid, "🤖 NÚCLEO IA: ANÁLISIS", funPhrase, "info");
